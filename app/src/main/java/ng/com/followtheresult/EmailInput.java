        ...
        verify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(got_email.equals("") || !got_email.matches(emailPattern)){
                    ...
                    //show dialog
                    myDialog = new Dialog(EmailInput.this);
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, RESEND_CODE,
                                ...
                                public void onResponse(String response) {
                                    ...
                                    try{
                                        ...
                                        if(status.equals("successful")){
                                            ...
                                            Toast.makeText(EmailInput.this, "Code sent successfully", Toast.LENGTH_SHORT).show();

                                            Intent i = new Intent(getApplicationContext(), EnterCode.class);
                                            ...
                                            myDialog.dismiss();
                                            Toast.makeText(EmailInput.this, "Code sending failed!, Please try again", Toast.LENGTH_SHORT).show();
                                        }
                                        ...
                                        e.printStackTrace();
                                        myDialog.dismiss();
                                        Toast.makeText(EmailInput.this, "Error!", Toast.LENGTH_SHORT).show();
                                    }
                            ...
                            new Response.ErrorListener() {
                                ...
                                public void onErrorResponse(VolleyError volleyError) {
                                    ...
                                    Toast.makeText(EmailInput.this, "Failed, check network connectivity and try again", Toast.LENGTH_SHORT).show();
                                }
                            }){
                        @Override
                    ...
                    RequestQueue requestQueue = Volley.newRequestQueue(EmailInput.this);
